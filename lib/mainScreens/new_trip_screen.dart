...
class _NewTripScreenState extends State<NewTripScreen>
{
  ...
  bool isRequestDirectionDetails = false;
    ...
    // step 2when driver accepts the user ride request
   //1. originlatlng = driver current position
  // destination latlng = userpickup location

  // step 2. user already picked up the user in his car
  ////1. originlatlng = driver pickup position
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    //user pickip location with icon
                    ...
                    const SizedBox(height: 10.0,),
                     ...
                     ElevatedButton.icon(
                         onPressed: () async
                         {
                           ...
                           //user has already sit in drivers car - driver start trip now - lets go button
                           ...
                           //user driver reached to the drpoff destination location - end trip location
